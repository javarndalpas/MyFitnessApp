                    ...
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <Link to="/" className="flex items-center">
                                <img src="https://static.vecteezy.com/system/resources/previews/015/845/443/non_2x/fitness-tracker-for-fitness-equipment-fitness-tracker-icon-suitable-for-apps-website-developer-graphic-designer-needs-on-white-background-free-vector.jpg" className="h-8 me-3" alt="FlowBite Logo" />
